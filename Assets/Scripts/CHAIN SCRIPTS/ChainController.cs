...
public class ChainController : MonoBehaviour
{
    ...
    [SerializeField] private TMP_Text _helpquote;
    ...
    public async void ChainMotion()
    {
        if (chainInProgress == false)
        {
            ...
            // fontMaterial.SetColor
            // thisViking.GetComponent<Renderer>().material.color = new UnityEngine.Color(rf, gf, bf, 1);
            
            // бетонируется ПРОЗРАЧНОСТЬ текста "press the fish"
            _helpquote.alpha = 0.1f;
            ...
            // тест останавливаем анимацию рыбы
